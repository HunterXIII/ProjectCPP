...
public:
    ...
    DateTime(
        ...
        u_int hours=0, u_int minutes=0, u_int seconds=0
    ...
    void string_to_date(std::string str) {
        ...
        */
        ...
        this->seconds = (year - 1970) * 31536000
                + (month - 1) * 2592000 
                + (day - 1)  * 86400
                + hours * 3600
                + minutes * 60
...
public:
    ...
    return !(end.getSeconds() < other.start.getSeconds() ||
            start.getSeconds() > other.end.getSeconds());   
    }
};